...
async function main() {
  ...
  assert.ok(help.includes('点歌'), 'help should include user-facing visible command');
  ...
  assert.ok(help.includes('内部操作已隐藏'), 'help should clearly explain hidden internal operations');
  assert.ok(adminHelp.includes('管理员快捷指令'), 'admin help should include admin shortcut section');
